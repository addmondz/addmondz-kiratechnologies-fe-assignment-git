            ...
            <div v-if="apiResponse">
                ...
                <div class="flex justify-between w-full pt-6 flex-col sm:flex-row">
                    <div class="flex justify-start flex-1">
                        <button class="bg-cyan-400 hover:brightness-110 text-white py-2 px-4 rounded border flex items-center transition duration-200" @click="fetchList(currentPage)"><ReloadOutlined class="mr-3" />Refresh</button>
                    </div>
